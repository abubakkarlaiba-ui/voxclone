    ...
    <div className="min-h-screen bg-[#090a0f]">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose-custom mt-8 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">2. Voice Data</h2>
            <p className="mt-3 text-sm leading-relaxed text-[#8b8fa3]">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">3. Generated Audio</h2>
            <p className="mt-3 text-sm leading-relaxed text-[#8b8fa3]">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">4. Account Information</h2>
            <p className="mt-3 text-sm leading-relaxed text-[#8b8fa3]">
